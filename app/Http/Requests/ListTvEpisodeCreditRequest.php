...
class ListTvEpisodeCreditRequest extends FormRequest
{
    ...
    {
        return [
            'tv_episode_id' => ['required', 'integer', 'min:1'],
    ...
    {
        return [
            'tv_episode_id.required' => 'tv_episode_id 不能为空',
            'tv_episode_id.integer' => 'tv_episode_id 必须是整数',
            'tv_episode_id.min' => 'tv_episode_id 最小值为 1',
